use crate::agent::{CoriolisApiAgent, CoriolisApiRequest, CoriolisApiResponse};
...
pub struct CoriolisApiLambdaAgent {
    client: Client,
    function_name: String,
}

impl CoriolisApiLambdaAgent {
    ...
    pub async fn new(running_env: String) -> Self {
        ...
        Self {
            client,
            function_name: format!("{}{}", running_env, "-coriolis-lambda-api"),
        }
    }

    fn build_request_payload(request: CoriolisApiRequest) -> Blob {
...
#[async_trait]
impl CoriolisApiAgent for CoriolisApiLambdaAgent {
    async fn call(
        &self,
